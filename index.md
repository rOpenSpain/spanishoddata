...
[`{duckdb}`](https://r.duckdb.org/) R package and is featured in the
[DuckDB Library](https://duckdb.org/library/spanishoddata-r-package/).

## Examples of available data

![](articles/media/flows_plot_barcelona.svg)
...
The [Figure 4](#fig-overall-flow) presents the overall approach to
...
![](reference/figures/README-distritos-1.png)
...
![](reference/figures/README-trips-per-hour-1.png)
...
![](reference/figures/README-desire-lines-1.png)
...
![](reference/figures/README-salamanca-zones-1.png)
...
![](reference/figures/README-salamanca-plot-1.png)
...
- The [pkgdown site](https://rOpenSpain.github.io/spanishoddata/)
  ...
  - [Making interactive
    ...
    with [spanishoddata](https://rOpenSpain.github.io/spanishoddata/)
