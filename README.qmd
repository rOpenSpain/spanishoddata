...
# Error: Conversion Error: Could not convert string 'externo' to UINT16
# LINE 3: GROUP BY id_origin, id_destination
#               ^
...
od_salamanca = od_multi_list |>
  ...
  list_rbind() |>
  group_by(origen, id_destination) |>
  summarise(Trips = sum(n_trips)) |>
  arrange(Trips)
...
DBI::dbDisconnect(con)
# # A tibble: 6 × 8
#      mes origen id_destination  edad  sexo   residencia recurrencia personas
