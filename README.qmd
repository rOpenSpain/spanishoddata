...
![Example of the data available through the package: interactive daily flows in Spain](man/figures/spain-folding-flows.gif){#fig-spain-flows}

![Example of the data available through the package: interactive daily flows in Barcelona with time filter](man/figures/barcelona-time.gif){#fig-spain-flows}
