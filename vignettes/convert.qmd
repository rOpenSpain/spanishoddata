...
db_1 <- spod_convert(type = "od", zones = "distr", dates = "cached_v1", save_format = "duckdb", save_path = "/tmp/test.duckdb")
```
...
db_2 <- spod_convert(type = "od", zones = "distr", dates = dates_2, overwrite = TRUE)
```
...
od_distr_feb14_feb16_2020 <- spod_convert(type = type, zones = zones, dates = dates, save_format = "parquet")
```
...
od_distr_feb16_feb19_2020 <- spod_convert(type = type, zones = zones, dates = dates, save_format = "parquet", overwrite = 'update')
```
