...
Here are the variables you can find in the `district`, `municipality` and `large urban area` level origin-destination data:
...
od_mean_trips_by_ses_over_the_4_days <- od_dist |>
  ...
  summarise(
    mean_n_trips = mean(n_trips, na.rm = TRUE),
    .groups = "drop") |> 
  collect()
...
```         
# A tibble: 39 × 4
   age   sex    income mean_n_trips
   <fct> <fct>  <fct>         <dbl>
 1 NA    NA     <10            6.27
 2 NA    NA     10-15          6.16
 3 NA    NA     >15            5.72
 4 0-25  NA     <10            7.83
 5 0-25  NA     10-15          8.16
 6 0-25  NA     >15            7.45
 7 0-25  female <10           13.7 
 8 0-25  female 10-15         12.7 
 9 0-25  female >15           13.7 
10 0-25  male   <10           13.1 
# ℹ 29 more rows
