...
Work-in-progress. Coming soon, please come back in a few weeks. For now, please consult the official documentation [@mitma-mobility-2024-v7]. Some data is already available in the same way as [v1 data](v1-2020-2021-mitma-data-codebook.html), just use dates starting with 2022-01-01.
