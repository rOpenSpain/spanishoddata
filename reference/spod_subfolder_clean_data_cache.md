...
Change subfolder name in the code of this function for clean data cache
here to apply globally, as all functions in the package should use this
function to get the clean data cache path.
...
A `character` string with the subfolder name for the clean data cache.
