...
This outlines how to propose a change to spanishoddata. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("rOpenSpain/spanishoddata", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://rOpenSpain.github.io/spanishoddata/CODE_OF_CONDUCT.md).
