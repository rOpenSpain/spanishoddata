...
#' spod_download_data(type = "od", zones = "districts", date_range = c("2020-03-20", "2020-03-24"))
#' 
#' # Download the origin-destination on district level for select dates in 2020 and 2021
#' spod_download_data(type = "od", zones = "dist", dates_list = c("2020-03-20", "2020-03-24", "2021-03-20", "2021-03-24"))
#' 
...
#' spod_download_data(type = "od", zones = "municip", date_regex = "2020032[0-4])
#' }
