...
- [Codebook and cookbook for v1 (2020-2021) Spanish mobility
  data](https://rOpenSpain.github.io/spanishoddata/articles/v1-2020-2021-mitma-data-codebook.md):
- [Codebook and cookbook for v2 (2022 onwards) Spanish mobility
  data](https://rOpenSpain.github.io/spanishoddata/articles/v2-2022-onwards-mitma-data-codebook.md):

### Get or convert data for analysis

- [Quicky get daily
  data](https://rOpenSpain.github.io/spanishoddata/articles/quick-get.md):
- [Download and convert mobility
  datasets](https://rOpenSpain.github.io/spanishoddata/articles/convert.md):

### Visualise flows

- [Making static flow
  maps](https://rOpenSpain.github.io/spanishoddata/articles/flowmaps-static.md):
- [Making interactive flow
  maps](https://rOpenSpain.github.io/spanishoddata/articles/flowmaps-interactive.md):
- [OD data
  disaggregation](https://rOpenSpain.github.io/spanishoddata/articles/disaggregation.md):
...
- [Data Science for Transport
  Planning](https://tdscience.github.io/dstp/):

  Course by [Robin Lovelace](https://github.com/robinlovelace), [Juan P.
